...
export const english = {
    message: {
      ...
      WhatInformationWeCollectDescription: `We collect data to create your user account, build up a family tree and profile of people in your family tree.
      To create your user account we require the following information: name, email address and gender.
      To create your family tree and profiles, we require name, gender and how family members are related. Other data you may additionally choose to store on the site includes birth years, locations, email and other contact details, biographical information and images.`,
      ...
      WhatWeDoWithInformationDescription: `We do not sell your data to any third parties. Your data is not shared or sold or used for any marketing purposes.
