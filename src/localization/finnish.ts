...
export const finnish = {
    message: {
      ...
      RelationName: 'Suhteen Nimi',
      RelationNames: 'Suhde Nimet',
      Cantonese: 'Kantonilainen',
      Jyutping: 'Jyutping',
      Mandarin: 'Mandariini',
      Pinyin: 'Pinyin',
      ...
      "Wife": "Vaimo",
      "Husband": "Aviomies",
      "Maternal Grandmother": "Äidillinen isoäiti",
      "Maternal Grandfather": "Äitiisä",
      "Paternal Grandmother": "Isoäiti isän puolelta",
      "Paternal Grandfather": "Isänisä",
      ...
      "Wife's Mother": "Vaimon äiti",
      "Wife's Father": "Vaimon isä",
      "Husband's Mother": "Aviomiehen äiti",
      "Stepdaughter": "tytärpuoli",
      "Stepson": "poikapuoli",
      "Daughter In Law": "miniä",
      "Son In Law": "vävy",
      "Granddaughter Daughter's Side": "Tyttärentytär Tytär&#39;s Side",
      "Grandson Daughter's Side": "Äitiyttären tytär",
      "Granddaughter Son's Side": "Tyttärentytär Pojan puolelta",
      "Grandson Son's Side": "Lapsenpojan poika",
      "Maternal Great Grandmother": "Äidin isoäiti",
      "Maternal Great Grandfather": "Äidin isoisä",
      "Paternal Great Grandmother": "Isän isoäiti",
      "Paternal Great Grandfather": "Isän isoisä",
      "Mother's Elder Sister": "Äidin vanhempi sisar",
      "Mother's Younger Sister": "Äidin nuorempi sisar",
      "Mother's Sister": "Äidin sisko",
      "Mother's Brother": "Äidin veli",
      "Father's Elder Sister": "Isän vanhin sisar",
      "Father's Younger Sister": "Isän nuorempi sisar",
      "Father's Sister": "Isän sisko",
      "Elder Sibling's Wife": "Vanhin sisaruksen vaimo",
      "Younger Sibling's Wife": "Nuorempi sisaruksen vaimo",
      "Elder Sibling's Husband": "Vanhin sisaruksen aviomies",
      "Younger Sibling's Husband": "Nuoremman sisaruksen aviomies",
      "Sister's Daughter": "Siskon tytär",
      "Sister's Son": "Sisar poika",
      "Brother's Daughter": "Veljen tytär",
      "Brother's Son": "Veljen poika",
      "Wife's Elder Sister": "Vaimon vanhempi sisar",
      "Wife's Younger Sister": "Vaimon nuorempi sisar",
      "Wife's Elder Brother": "Vaimon vanhin veli",
      "Wife's Younger Brother": "Vaimon nuorempi veli",
      "Husband's Elder Sister": "Aviomiehen vanhin sisar",
      "Husband's Younger Sister": "Aviomiehen nuorempi sisar",
      "Husband's Elder Brother": "Aviomiehen vanhin veli",
      "Husband's Younger Brother": "Aviomiehen nuorempi veli",
      "Maternal Elder Female Cousin": "Äiti vanhin nainen serkku",
      "Maternal Younger Female Cousin": "Äiti nuorempi nainen serkku",
      "Maternal Elder Male Cousin": "Äiti vanhin mies serkku",
      "Maternal Younger Male Cousin": "Äiti nuorempi mies serkku",
      "Paternal Elder Female Cousin": "Isän vanhimman naisen serkku",
