...
export const traditionalChinese = {
    message: {
      ...
      ViewDetails: '查看詳情',
      OurStory: '我們的故事',
      OurStoryStub: '你想知道我們如何和為什麼建立這個網站的故事嗎？',
      ContactUs: '聯繫我們',
      ContactUsStub: '如果您有任何疑問，希望報告中的錯誤，要求一個功能或有助於源代碼。',
      FAQ: '常問問題',
      FAQStub: '經常問的問題',

      StoryHeading: '它是如何開始',
      StoryText1: `你好。我在左邊賈斯汀。而我在右邊阿德里安`,
      StoryText2: `這是一個網站來記錄我們的家譜和行為有點像社交網絡。您可以在這裡保持一個配置文
      件，發現樹達到多遠！
      ...
      ContactHeading: '聯繫',
      ContactEmail: `通過電子郵件<a href="mailto:info@okkindred.com">info@okkindred.com</a>與我"
      們聯繫`,
      ContactText1: `如果您對我們的家庭，我們希望收到你的來信，並歡迎各界人士光臨，並保持周圍的任
      何時間。
      如果你有一個登錄這個網站，是我家庭的一部分，你可以得到我的電話號
      碼和地址從我的個人資料！`,
      ContactText2: `另外，如果您正在使用該網站尋找一些幫助，或者即使你想讓我們幫你建立自己的類似
      網站請給我們行！`,
      ContactText3: `我們是相當不錯的人，做喜歡跟感興趣的薩姆斯的事情，我們也是人：野人的東西，軟
      件，音樂和瘋狂的泛全球的中國家庭...`,

      FAQHeading: '經常問的問題',
      Question1: '任何人都可以看到我家的信息？',
      Answer1: `沒有，只有你邀請你的家庭樹內的人可以看到您輸入的信息。這些信息也不會被外部用
      戶或搜索引擎進行搜索。`,

      Question2: `我的信息安全嗎？`,
      Answer2: `我們非常重視安全和隱私非常重視。我們一直在這個網站我們家的細節，我們永遠不會
      做任何損害這些數據！
      你邀請來共享你的樹只有你自己的家庭成員都能夠看到你在網站上輸入的
      信息。
      此外，我們不會出售，交易或出租您的個人身份信息給他人。`,
      Answer2a: `該網站託管與
      ...
      度，所以我們可以繪製它在地圖上。`,
      Answer2b: `如果您擔心，該網站是完全開源的，所以你可以把源代碼副本（見下文），看看你的信
      息如何存儲，甚至舉辦自己的這個網站的版本。
      我們將很樂意幫助你設置它多了起來。`,

      Question3: `我可以看到源代碼？`,
      Answer3: `源代碼位於<a href="https://github.com/JustinWingChungHui/okKindred">Github.com</a>。
      你看到什麼okKindred.com從“生產”分支跳轉。`,
      Answer3a: `我們與這意味著您可以自由使用，複製和修改代碼以實現自己的目的的
      ...
      "實例。`,
      Answer3b: `我們歡迎任何人誰有任何意見或誰願意參與這一項目，並使其更好！我們特別需要翻譯
      成其他語言的幫助。
      請<a href="mailto:info@okkindred.com?subject=Development">取得聯繫</a>
      如果您想貢獻，或（甚至更好），使在Github上拉請求:)`,

      Question4: `是什麼在它適合你，如果它是免費的嗎？`,
      Answer4: `我們是軟件開發者，這是在課餘時間，擴大我們的技能，並加入到我們的產品來向別人
      炫耀創建的項目。
      ...
      Answer6: `沒有此刻沒有。這些圖像存儲在<a href="https://aws.amazon.com/s3/">Amazon S3</a>
      所以我們不介意立足點的成本，這是非常非常便宜。
      但是，如果有很多用戶開始上傳圖片的成千上萬，我們將創建一個限制。`,

      Question7: `我可以宣傳你的網站？`,
      Answer7: `我們沒有計劃通過廣告主要是因為我們不希望受到我們的祖母給任何更多的廣告比他們
      目前得到的網站上，以籌集資金。`,
      ...
      列表Github上。
      如果它是一個安全漏洞需要盡快知道，以便我們能夠解決它！`,

      Question9: `你可以添加一個功能，因此它可以做XXXXX嗎？`,
      Answer9: `隨時通過
      <a href="mailto:info@okkindred.com?Subject=Feature%%20Request">info@okkindred.com</a>
      索要新功能。我們肯定會考慮他們，特別是如果這將有利於很
      多人（即我們的家庭）。
      這個網站是在課餘時間完成的，所以他們做的時候功能要求會做。`,

      Question10: `其他家譜網站查找當地的記錄，以幫助創建樹，你可以這樣做？`,
      Answer10: `我們沒有計劃尚未實現這一點。是的原因是，大多數我們的家庭從中國起源。
      因為清朝的最後十年期間，在中國發生在20世紀和不穩定的內戰，
      一些可用的記錄存在，這將是對我們有利的。`,
      Answer10a: `鑑於許多家譜網站已經這樣做了，我們會嘗試更多的精力在這個項目上的社交網絡
      側。
      然而，這並不是說，如果在時間上非常需要變得明顯，我們不會看看如何
      實現這樣的功能。`,

      Question11: `為了描述關係，你有'合作'，但不是'結婚'，你'長大'，但不是'生了“？`,
      Answer11: `我們試圖保持網站盡可能簡單和盡可能具有包容性。的“凸起”，“提出者”和定義，'合
      作'提供足夠的信息來構建樹。
      它們包括不具有婚姻觀念的跨文化關係。
      ...
      "Granddaughter Daughter's Side": "Granddaughter Daughter's Side",
      "Grandson Daughter's Side": "Grandson Daughter's Side",
      "Granddaughter Son's Side": "Granddaughter Son's Side",
      "Grandson Son's Side": "Grandson Son's Side",
      'Maternal Great Grandmother': 'Maternal Great Grandmother',
      'Maternal Great Grandfather': 'Maternal Great Grandfather',
      'Paternal Great Grandmother': 'Paternal Great Grandmother',
      'Paternal Great Grandfather': 'Paternal Great Grandfather',
      "Mother's Elder Sister": "Mother's Elder Sister",
      ...
      "Father's Younger Sister": "Father's Younger Sister",
      "Father's Sister": "Father's Sister",
      "Elder Sibling's Wife": "Elder Sibling's Wife",
      "Younger Sibling's Wife": "Younger Sibling's Wife",
      "Elder Sibling's Husband": "Elder Sibling's Husband",
      "Younger Sibling's Husband": "Younger Sibling's Husband",
      ...
      "Wife's Elder Sister": "Wife's Elder Sister",
      "Wife's Younger Sister": "Wife's Younger Sister",
      "Wife's Elder Brother": "Wife's Elder Brother",
      "Wife's Younger Brother": "Wife's Younger Brother",
      "Husband's Elder Sister": "Husband's Elder Sister",
      "Husband's Younger Sister": "Husband's Younger Sister",
      "Husband's Elder Brother": "Husband's Elder Brother",
      "Husband's Younger Brother": "Husband's Younger Brother",
      'Maternal Elder Female Cousin': 'Maternal Elder Female Cousin',
      'Maternal Younger Female Cousin': 'Maternal Younger Female Cousin',
      'Maternal Elder Male Cousin': 'Maternal Elder Male Cousin',
      'Maternal Younger Male Cousin': 'Maternal Younger Male Cousin',
      'Paternal Elder Female Cousin': 'Paternal Elder Female Cousin',
      ...
      YourDataProtectionRightsDescription: `您有權要求我們提供您的個人信息的副本，以及
      糾正您認為不正確的信息。
      您也有權要求我們完成您認為不完整的信息。
      您有權要求我們刪除您的個人信息。
      您有權要求我們限制您信息的處理。
      您有權反對處理您的個人數據。
      您有權要求我們將您提供給我們的信息轉移給另一個組織或您。
      您無需為行使權利而支付任何費用。 如果您提出要求，我們有一個月的時間回复您。
      我們只有在進行刑事調查時，或者在確立，行使或捍衛法律主張時有必要拒絕這些權利。`,
